...
/** <!--********************************************************************-->
 *
 * @fn node *CLFdoCreateLoopFun( node *syntax_tree)
 *
 ...
 *****************************************************************************/
node *
CLFdoCreateLoopFun (node *fundef, node *assigns,
                    ...
                    node *in_mem, node *out_mem, node **lacfun_p)
{
    ...
    comp_predicate = TBmakeAvis (TRAVtmpVarName ("iterator"),
                                 TYmakeAKS (TYmakeSimpleType (T_int), SHmakeShape (0)));
    ...
    *lacfun_p = TBmakeFundef (fundef_name, fundef_ns, fundef_rets, fundef_args,
    ...
    while (fundef_args != NULL) {
        if (ARG_AVIS (fundef_args) == LUTsearchInLutPp (INFO_DUPLUT (arg_info), in_mem)) {
            ...
            if (recursive_args == NULL) {
                recursive_args = TBmakeExprs (TBmakeId (ARG_AVIS (fundef_args)), NULL);
            } else {
                recursive_args
                  = TCappendExprs (recursive_args,
    ...
    recursive_ap
      = TBmakeAssign (TBmakeLet (TBmakeIds (recursive_ret, NULL), recursive_ap), NULL);
...
/** <!--********************************************************************-->
 *
 * @fn node *CLFassign( node *arg_node, info *arg_info)
 *
 *   @brief
 *
 *   @param arg_node
 ...
 *****************************************************************************/
node *
CLFassign (node *arg_node, info *arg_info)
{
    DBUG_ENTER ();
...
/** <!--********************************************************************-->
 *
 * @fn node *CLFids( node *arg_node, info *arg_info)
 *
 *   @brief
 *
 *   @param arg_node
 ...
 *****************************************************************************/
node *
CLFids (node *arg_node, info *arg_info)
{
    node *dup_avis;
...
/** <!--********************************************************************-->
 *
 * @fn node *CLFid( node *arg_node, info *arg_info)
 *
 *   @brief
 *
 *   @param arg_node
 ...
 *****************************************************************************/
node *
CLFid (node *arg_node, info *arg_info)
{
    node *dup_avis;
