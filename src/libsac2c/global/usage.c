...
PrintMultithreadOptions (void)
{
    ...
    printf ("\n\nMULTI-THREAD OPTIONS:\n\n"
            ...
            "\n"
            "                      alt:    bind alternative PUs. NOTE: can only be used "
            "if\n"
            "                              threads <= to half the available PUs\n "
            "\n"
            "           thr_per_socket:    bind 1 thread per socket. NOTE: can only be "
            "used if\n"
            "                              threads <= to available sockets\n"
            "\n"
            "    -mt_smart_mode <mode>\n"
