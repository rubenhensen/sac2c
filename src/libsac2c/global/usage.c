...
PrintBackendOptions (void)
{
    ...
    printf (
      ...
      "                         RC is done through messages to a seperate core.\n"
      ...
      "                      local_norc_ptr\n"
      "                         Same as previous BUT encodes the mode in\n"
      "                         the lowewst bits of the pointer to the descriptor.\n"
      "                      async_norc_copy_desc\n"
      "                         Switches from async to norc and back.\n"
      "                         Whenever going norc, the descriptor is being copied.\n"
      "                      async_norc_two_descs\n"
      "                         Same as previous but instead of copying we always.\n"
      "                         allocate two descriptors.\n"
      "                      async_norc_ptr\n"
      "                         Same as previous but instead of having two descriptors.\n"
      "                         we encode the mode in the pointer.\n"
      "                      local_pasync_norc_cpy_desc\n"
      "                         Very similar to local_norc_desc.\n"
      "                         The only difference is that when spawning a.\n"
      "                         thread we create a copy of the descriptor and use.\n"
      "                         the original one as asynchronous parent.\n"
      "                      local_async_norc_ptr\n"
      "                         Very similar to async_norc_ptr.\n"
      "                         The only difference is that we start in local and\n"
      "                         we try to get back there whenever possible.\n"
      "                    (default: local / local_pasync_norc_cpy_desc (BE_mutc))\n");
