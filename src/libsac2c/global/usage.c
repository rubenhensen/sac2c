...
PrintCudaOptions (void)
{
    ...
    printf ("\n\nCUDA OPTIONS:\n"
            ...
            "\n"
            "    -cuda_gpu_branching\n"
            "                    Switch to a branching implementation when recovering index spaces\n"
            "                    from CUDA thread spaces in CUDA kernel mappings.\n"
...
PrintPrintingOptions (void)
{
    ...
    printf (
      ...
      "                 Example usage: -b ptc:goi -printfun foo\n"
      "\n"
      "    -printfunsets [aiudwp]+\n"
      ...
      "BIG.\n"
      "               Assuming the phase \"opt\" corresponds with phase number 10,\n"
      "               another way of writing the above arguments is as follows:\n"
      "               -printstart 10:cyc:cse -printstop opt:cyc:cse\n"
      "\n");
...
PrintCompiletimeMessagingOptions (void)
{
    ...
    printf (
      ...
      "                    line breaks.\n"
      "                    (default: terminal width if stderr outputs to a console,\n"
      "                              0 otherwise = %d)\n"
      "\n"
      ...
      "                    the message type (error, warning or note).\n"
      "                    The string may also contain '@` to indicate desired\n"
      "                    line breaks.\n"
      "                    (default: \"%s\")\n"
      "\n"
