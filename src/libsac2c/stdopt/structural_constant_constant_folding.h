...
extern node *SCCFprf_mask_SxSxV (node *arg_node, info *arg_info);
extern node *SCCFprf_mask_SxVxS (node *arg_node, info *arg_info);
extern node *SCCFprf_mask_SxVxV (node *arg_node, info *arg_info);
extern node *SCCFprf_mask_VxSxS (node *arg_node, info *arg_info);
extern node *SCCFprf_mask_VxSxV (node *arg_node, info *arg_info);
