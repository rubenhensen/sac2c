...
DLIRfundef (node *arg_node, info *arg_info)
{
    ...
    DBUG_ENTER ("DLIRfundef");

    DBUG_PRINT ("DLIR",
                ("do-loop-invariant removal in fundef %s", FUNDEF_NAME (arg_node)));
    ...
    if (((FUNDEF_ISLACFUN (arg_node))
        ...
        /* traverse args */
        DBUG_PRINT ("DLIR", ("Traversing FUNDEF_ARGS for %s", FUNDEF_NAME (arg_node)));
        ...
        if (FUNDEF_BODY (arg_node) != NULL) {
            DBUG_PRINT ("DLIR",
                        ("Traversing FUNDEF_BODY for %s", FUNDEF_NAME (arg_node)));
 ...
 *****************************************************************************/
node *
DLIRdoLoopInvariantRemovalOneFundef (node *fundef)
{
    info *info;
 ...
 *****************************************************************************/
node *
DLIRdoLoopInvariantRemoval (node *module)
{
    int movedsofar;
