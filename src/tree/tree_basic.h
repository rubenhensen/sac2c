 ...
 * used by compile.c for generating refcounting instructions in the context
 * of a do-loop.
 * SKIP contains a block of adjust_rc operations that has to be skipped
 * over in the first iteration of a do-loop
 * LABEL contains the jump label for skipping over this block
 */
