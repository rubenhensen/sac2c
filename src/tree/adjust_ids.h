...
extern node *AIvardec (node *arg_node, info *arg_info);
extern node *AIarg (node *arg_node, info *arg_info);
extern node *AIassign (node *arg_node, info *arg_info);
extern node *AIlet (node *arg_node, info *arg_info);
extern node *AIap (node *arg_node, info *arg_info);
extern node *AIreturn (node *arg_node, info *arg_info);
extern node *AIexprs (node *arg_node, info *arg_info);
extern node *AIid (node *arg_node, info *arg_info);
extern node *AIids (node *arg_node, info *arg_info);
extern node *AIwith (node *arg_node, info *arg_info);
extern node *AIwith2 (node *arg_node, info *arg_info);
