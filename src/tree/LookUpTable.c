 ...
 *  hash table has been occupied another fragments is allocated and appended
 *  to the hash table.
 */
 ...
 */
#define LUT_KEYS_POINTER 1
#define LUT_KEYS_STRING 1
