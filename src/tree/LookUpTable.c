...
LUTremoveContentLut (lut_t *lut)
{
    ...
    DBUG_ENTER ("LUTremoveContentLut");
...
LUTsearchInLutNextP (void)
{
    ...
    DBUG_ENTER ("LUTsearchInLutNextP");
...
LUTsearchInLutNextS (void)
{
    ...
    DBUG_ENTER ("LUTsearchInLutNextS");
