...
{
    node *old_info2, *first_assign, *next_assign, *tmp, *icm_arg, *form, *to,
      *type_id_node, *arg, *res, *res_ref, *dim_node, *index, *indexlen, *old_arg_node,
      *last_assign;
    int dim;
    simpletype s_type;
