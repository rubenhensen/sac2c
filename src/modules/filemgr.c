...
#define NUMDECPATHS 7

static char *stddecpaths[] = {"stdlib/modules/structures",
                              "stdlib/modules/numerical",
                              "stdlib/classes/random",
                              "stdlib/world/stdio",
                              "stdlib/world/system",
                              "stdlib/world/x-window",
                              "stdlib/hidden"};

#define NUMLIBPATHS 7

static char *stdlibpaths[] = {"stdlib/modules/structures/lib",
                              "stdlib/modules/numerical/lib",
                              "stdlib/classes/random/lib",
                              "stdlib/world/stdio/lib",
                              "stdlib/world/system/lib",
                              "stdlib/world/x-window/lib",
                              "stdlib/hidden/lib"};
...
{
    int i;
    char buffer[MAX_PATH_LEN], *sac_home;
