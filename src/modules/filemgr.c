 ...
 *  internal funs : ---
 *  external funs : sprintf, tmpnam, SystemCall
 *  macros        :
 *
 *  remarks       :
 *
...
CreateTmpDirectories ()
{
    ...
    sprintf (store_dirname, "%s_store/", tmp);
    DBUG_PRINT ("FILE", ("store_dirname is %s", store_dirname));

    sprintf (build_dirname, "%s_build/", tmp);
