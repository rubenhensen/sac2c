...
pat(`SAC_MUTC_ND_GET_VAR_INOUT', `0', `1', `NT_USG')
rule(`SAC_MUTC_ND_GET_VAR_INOUT', `SAC_MUTC_GET_PAR', `PAR')
rule(`SAC_MUTC_ND_GET_VAR_INOUT', `SAC_MUTC_GET_PAR', `PIO')
rule(`SAC_MUTC_ND_GET_VAR_INOUT', `SAC_MUTC_GET_VAR', `*USG')
