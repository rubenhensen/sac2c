#define SAC_MUTC_WORLD_OBJECT                                                             \
    ...
    SAC_ND_DECL__DATA ((SACo_MUTC_IO__mutcWorld,                                          \
                        (SCL, (NHD, (NUQ, (INT, (GLO, (NON, ))))))),                      \
                       int, )                                                             \
    SAC_ND_DECL__DESC ((SACo_MUTC_IO__mutcWorld,                                          \
                        (SCL, (NHD, (NUQ, (INT, (GLO, (NON, ))))))), )                    \
    SAC_NOTHING ()                                                                        \
    SAC_MUTC_START_DEF_FUN2 (SACf_MUTC_IO__to_MUTC_IO__i, void, VOID,                     \
    ...
    SAC_MUTC_START_DEF_FUN2 (SACf_MUTC_IO_CL_INIT__init_mutcWorld__SACt_MUTC_IO__MUTC_IO, \
                             void, VOID,                                                  \
    ...
    {                                                                                     \
        ...
        SAC_ND_CREATE__SCALAR__DATA ((SACp_emal_2726__isaa_1643__OI_object,               \
                                      (SCL, (NHD, (NUQ, (INT, (GLO, (NON, ))))))),        \
                                     0)                                                   \
        SAC_MUTC_FUNAP2 (SACf_MUTC_IO__to_MUTC_IO__i,                                     \
