...
rule(`SAC_MT_BARRIER_ELEMENT_out', `SAC_MT_BARRIER_ELEMENT_out__DESC', `AKS')
...
pat(`SAC_MT_SEND_RESULT_out', `3', `0', `NT_SHP')
rule(`SAC_MT_SEND_RESULT_out', `SAC_MT_SEND_RESULT_out__NODESC', `SCL')
rule(`SAC_MT_SEND_RESULT_out', `SAC_MT_SEND_RESULT_out__DESC', `AKS')
rule(`SAC_MT_SEND_RESULT_out', `SAC_MT_SEND_RESULT_out__DESC', `AKD')
rule(`SAC_MT_SEND_RESULT_out', `SAC_MT_SEND_RESULT_out__DESC', `AUD')
...
pat(`SAC_MT_RECEIVE_RESULT_out', `3', `0', `NT_SHP')
rule(`SAC_MT_RECEIVE_RESULT_out', `SAC_MT_RECEIVE_RESULT_out__NODESC', `SCL')
rule(`SAC_MT_RECEIVE_RESULT_out', `SAC_MT_RECEIVE_RESULT_out__DESC', `AKS')
rule(`SAC_MT_RECEIVE_RESULT_out', `SAC_MT_RECEIVE_RESULT_out__DESC', `AKD')
rule(`SAC_MT_RECEIVE_RESULT_out', `SAC_MT_RECEIVE_RESULT_out__DESC', `AUD')
...
pat(`SAC_MT_SYNC_FOLD_in', `2', `3')
rule(`SAC_MT_SYNC_FOLD_in', `SAC_MT_SYNC_FOLD__NOOP')

pat(`SAC_MT_SYNC_FOLD_inout', `2', `3')
rule(`SAC_MT_SYNC_FOLD_inout', `SAC_MT_SYNC_FOLD__NOOP')

pat(`SAC_MT_SYNC_FOLD_out', `2', `3', `NT_SHP')
rule(`SAC_MT_SYNC_FOLD_out', `SAC_MT_SYNC_FOLD_out__NODESC', `SCL')
rule(`SAC_MT_SYNC_FOLD_out', `SAC_MT_SYNC_FOLD_out__DESC', `AKS')
rule(`SAC_MT_SYNC_FOLD_out', `SAC_MT_SYNC_FOLD_out__DESC', `AKD')
rule(`SAC_MT_SYNC_FOLD_out', `SAC_MT_SYNC_FOLD_out__DESC', `AUD')
