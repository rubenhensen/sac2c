...
pat(`SAC_MT_FRAME_ELEMENT_inout', `3', `NT_SHP')
...
pat(`SAC_MT_FRAME_ELEMENT_in', `3', `NT_SHP')
...
pat(`SAC_MT_FRAME_ELEMENT_out', `3')
rule(`SAC_MT_FRAME_ELEMENT_out', `SAC_MT_FRAME_ELEMENT_out__NOOP')


pat(`SAC_MT_BARRIER_ELEMENT_inout', `3', `NT_SHP')
...
pat(`SAC_MT_BARRIER_ELEMENT_out', `3', `NT_SHP')
...
pat(`SAC_MT_BARRIER_ELEMENT_in', `3')
rule(`SAC_MT_BARRIER_ELEMENT_in', `SAC_MT_BARRIER_ELEMENT_in__NOOP')


pat(`SAC_MT_SEND_PARAM_in', `2', `NT_SHP')
...
pat(`SAC_MT_SEND_PARAM_inout', `2', `NT_SHP')
...
pat(`SAC_MT_SEND_PARAM_out', `2')
rule(`SAC_MT_SEND_PARAM_out', `SAC_MT_SEND_PARAM_out__NOOP')


pat(`SAC_MT_RECEIVE_PARAM_in', `3', `NT_SHP', `NT_HID')
...
pat(`SAC_MT_RECEIVE_PARAM_inout', `3', `NT_SHP', `NT_HID')
...
pat(`SAC_MT_RECEIVE_PARAM_out', `3')
