...
pat(`SAC_ND_A_MIRROR_LOCAL_TO', `0', `0', `NT_DIS')
rule(`SAC_ND_A_MIRROR_LOCAL_TO', `SAC_ND_A_MIRROR_LOCAL_TO__DEFAULT', `DIS')
rule(`SAC_ND_A_MIRROR_LOCAL_TO', `SAC_ND_A_MIRROR_LOCAL_TO__UNDEF', `*DIS')
...
pat(`SAC_ND_A_MIRROR_PTR_CACHE_TO', `0', `0', `NT_DIS')
rule(`SAC_ND_A_MIRROR_PTR_CACHE_TO', `SAC_ND_A_MIRROR_PTR_CACHE_TO__DEFAULT', `DIS')
rule(`SAC_ND_A_MIRROR_PTR_CACHE_TO', `SAC_ND_A_MIRROR_PTR_CACHE_TO__UNDEF', `*DIS')
...
rule(`SAC_ND_FREE__DATA', `SAC_ND_FREE__DATA__AKS_NHD_DSM', `AKS', `NHD', `DSM')
...
rule(`SAC_ND_FREE__DATA', `SAC_ND_FREE__DATA__AKD_AUD_NHD_DSM', `AKD', `NHD', `DSM')
...
rule(`SAC_ND_FREE__DATA', `SAC_ND_FREE__DATA__AKD_AUD_NHD_DSM', `AUD', `NHD', `DSM')
