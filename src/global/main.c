...
main (int argc, char *argv[])
{
    ...
    /*
     *  If mt-code is generated by the new method, we should do
     *  the refcount after mt-phase, while in the old version
     *  we can do it now (where it was done before new-mt was added).
     */
