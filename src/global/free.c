...
strings *FreeOneStrings(strings *fr)
{
  strings *tmp;
...
strings *FreeAllStrings(strings *fr)
{
...
nodelist *FreeNodelist(nodelist *list)
{
  nodelist *tmp;
...
node *FreeModul(node *arg_node, node *arg_info)
{
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_modul node ..."));
...
node *FreeModdec(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_moddec node ..."));
...
node *FreeClassdec(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_classdec node ..."));
...
node *FreeSib(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_sib node ..."));
...
node *FreeImplist(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
#ifndef NEWTREE
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_implist node %s ...",
              IMPLIST_NAME(arg_node)));
...
node *FreeExplist(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_explist node ..."));
...
node *FreeTypedef(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
#ifndef NEWTREE
  int nnode_default=arg_node->nnode;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_typedef node %s ...", 
              ItemName(arg_node)));
...
node *FreeObjdef(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
#ifndef NEWTREE
  int nnode_default=arg_node->nnode;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_objdef node %s ...", 
              ItemName(arg_node)));
...
node *FreeFundef(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
#ifndef NEWTREE
  int nnode_default=arg_node->nnode;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_fundef node %s ...", 
              ItemName(arg_node)));
...
node *FreeArg(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
#ifndef NEWTREE
  int nnode_default=1;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_arg node %s ...", 
              ARG_NAME(arg_node)));
...
node *FreeBlock(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_block node ..."));
...
node *FreeVardec(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
#ifndef NEWTREE
  int nnode_default=1;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_vardec node %s ...", 
...
node *FreeAssign(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
#ifndef NEWTREE
  int nnode_default=2;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_assign node ..."));
...
node *FreeLet(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_let node ..."));
...
node *FreeCast(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
...
node *FreeReturn(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_return node ..."));

  FREETRAV(RETURN_EXPRS(arg_node));
  
  DBUG_PRINT("FREE",
             ("Removing N_return node ..."));
...
node *FreeCond(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_cond node ..."));
...
node *FreeDo(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_do node ..."));
...
node *FreeWhile(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_while node ..."));
...
node *FreeAp(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_ap node %s ...", 
              AP_NAME(arg_node)));
...
node *FreeWith(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_with node ..."));
...
node *FreeGenerator(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_generator node ..."));
...
node *FreeGenarray(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
...
node *FreeModarray(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
...
node *FreeFoldprf(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
...
node *FreeFoldfun(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_foldfun node %s ...",
...
node *FreeExprs(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
#ifndef NEWTREE
  int nnode_default=2;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_exprs node ..."));
...
node *FreeArray(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
...
node *FreeVinfo(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
#ifndef NEWTREE
  int nnode_default=1;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_vinfo node ..."));
...
node *FreeId(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_id node %s ...", ID_NAME(arg_node)));
...
node *FreeNum(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
...
node *FreeChar(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
...
node *FreeFloat(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
...
node *FreeDouble(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
...
node *FreeBool(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
...
node *FreeStr(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_str node %s ...",
              STR_STRING(arg_node)));
...
node *FreePrf(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_prf node ..."));
...
node *FreeEmpty(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
...
node *FreePost(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_post node %s ...", POST_ID(arg_node)));

  FREE(POST_ID(arg_node));
  
  DBUG_PRINT("FREE",
             ("Removing N_post node ..."));
...
node *FreePre(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_pre node %s ...", PRE_ID(arg_node)));
...
node *FreeInc(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
...
node *FreeDec(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
...
node *FreeIcm(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
#ifndef NEWTREE
  int nnode_default=2;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_icm node %s ...", ICM_NAME(arg_node)));
...
node *FreePragma(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
  ...
  DBUG_PRINT("FREE",
             ("Removing contents of N_pragma node ..."));
...
node *FreeInfo(node *arg_node, node *arg_info)
{
  node *tmp=NULL;
...
void FreePrf2(node *arg_node, int arg_no)
{
  node *tmp1,
       *tmp2;
  int i;
  ...
  while (NULL!=tmp1)
    {
    if (i != arg_no) FreeTree(tmp1->node[0]);
    tmp2 = tmp1;
    tmp1 = tmp1->node[1];
    FREE(tmp2);
    i++;
