...
/** <!--********************************************************************-->
 *
 * @fn node *RDEPENDSelId(node *arg_node, info *arg_info)
 *
 ...
 ******************************************************************************/
node *
RDEPENDSelId (node *arg_node, info *arg_info)
{
    DBUG_ENTER ("RDEPENDSelId");
...
/** <!--********************************************************************-->
 *
 * @fn node *RDEPENDprfSel(node *arg_node, info *arg_info)
 *
 *   @brief
 *
...
RDEPENDprfSel (node *arg_node, info *arg_info)
{
    ...
    PRF_ARG2 (arg_node) = RDEPENDSelId (PRF_ARG2 (arg_node), arg_info);
...
/** <!--********************************************************************-->
 *
 * @fn node *ResolveDependencies(node *assigns, node *cexprs, node *withid,
 *                               node *fusionable_wl)
 *
...
node *
ResolveDependencies (node *assigns, node *cexprs, node *withid, node *fusionable_wl)
{
    funtab *tmp_tab;
    info *arg_info;
